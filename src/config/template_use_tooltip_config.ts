import { Text, Dropdown, Button, RadioButton, TextArea, Checkbox, Table, Tooltip, Notification, Spinner } from 'kintone-ui-component';
...
(async (PLUGIN_ID: string) => {
  ...
  try {
    ...
    const tooltipText1 = new Tooltip({
      title: 'サンプルツールチップです。',
      container: text1,
      placement: 'bottom',
      describeChild: true,
      className: 'hazime-config-tooltip'
    });
    divContent.appendChild(tooltipText1);
    ...
    const tooltipText2 = new Tooltip({
      title: 'サンプルツールチップです。',
      container: text2,
      placement: 'bottom',
      describeChild: true,
    ...
    divContent.appendChild(tooltipText2);
    ...
    const tooltipText3 = new Tooltip({
      title: 'サンプルツールチップです。',
      container: text3,
      placement: 'bottom',
      describeChild: true,
    ...
    divContent.appendChild(tooltipText3);
    ...
    const tooltipTextArea = new Tooltip({
      title: 'サンプルツールチップです。',
      container: textArea,
      placement: 'bottom',
      describeChild: true,
    ...
    divContent.appendChild(tooltipTextArea);
    divContent.appendChild(createMarginTopElement()); // 改行
    ...
    divContent.appendChild(tooltipDropDown);
    ...
    const tooltipRadioButton = new Tooltip({
      title: 'サンプルツールチップです。',
    ...
    divContent.appendChild(tooltipRadioButton);
    ...
    const tooltipCheckBox = new Tooltip({
      title: 'サンプルツールチップです。',
      container: checkBox,
      placement: 'bottom',
      describeChild: true,
    ...
    divContent.appendChild(tooltipCheckBox);
    divContent.appendChild(createMarginTopElement()); // 改行

    // ------------------------------------------------

    const renderText = (rowText: any) => {
      {
        const text = new Text({
          value: rowText || '',
          placeholder: '値を入れてください。',
    ...
    const tooltipTable = new Tooltip({
      title: 'サンプルツールチップです。XXXXXXXXXXX ｜ YYYYYYYYYYY ｜ ZZZZZZZZZZZ',
      container: table,
      placement: 'top',
      describeChild: true,
      className: 'hazime-config-tooltip'
    });
    divContent.appendChild(tooltipTable);
